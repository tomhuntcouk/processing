...
class Matrix4 extends Array {
	...
	rotate( degrees, axis ) {
		// console.log(degrees, axis);
		glMatrix.mat4.rotate( this, this, radians(degrees), axis );
		return this;
	}
	...
	applyToPoint( vector3 ) {
		glMatrix.vec3.transformMat4( vector3, vector3, this );	
		return vector3;
	}
}
...
class Vector3 extends Vector {
	...
	// 	return glMatrix.vec3.rotate( this, this, center, radians(degrees) );
	// }
}
